...
from .models import Collection, Product, Review, Cart, CartItem, OrderItem, Customer, Order, ProductImage
from .permission import IsAdminOrReadOnly, FullDjangoModelPermissions, ViewCustomerHistoryPermission
...
class CartItemViewSet(ModelViewSet):
    ...
    def get_serializer_context(self):  # 获取URL上下文对象将其传递给序列化程序
